...
class MigrationRunner:
    ...
    async def apply_migration(self, conn: asyncpg.Connection, version: str, name: str, file_path: Path) -> None:
    ...
    async def _get_migration_status_with_connection(self, conn: asyncpg.Connection) -> dict:
