...
def demo_automatic_loading():
    ...
    # Check initial state
    print(
        f"   📊 Initial plugin loading state: {'enabled' if not is_plugin_loading_disabled() else 'disabled'}"
    )
    ...
    print(
        f"   📊 Plugin loading state: {'enabled' if not is_plugin_loading_disabled() else 'disabled'}"
    )
    ...
    enable_plugins()
    print(
        f"   📊 Re-enabled plugin loading: {'enabled' if not is_plugin_loading_disabled() else 'disabled'}"
    )

    # Use context manager
    with no_plugins():
        print(
            f"   🔒 Inside context: {'enabled' if not is_plugin_loading_disabled() else 'disabled'}"
        )
    ...
    print(
        f"   🔓 Outside context: {'enabled' if not is_plugin_loading_disabled() else 'disabled'}"
    )
