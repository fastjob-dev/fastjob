...
async def test_retry_mechanism():
    ...
    try:
        ...
        async with pool.acquire() as conn:
            ...
            job_record = await conn.fetchrow("SELECT * FROM fastjob_jobs WHERE id = $1", uuid.UUID(actual_job_id_1))
...
async def test_task_discovery():
    ...
    try:
        ...
        job_id = await enqueue(discovered_job_meta["func"], message="Hello from discovered job!")
