...
class TestDatabaseContextSystem:
    ...
    async def test_context_manager_integration(self):
        ...
        from fastjob.db.context import set_current_context, get_current_context, DatabaseContext
        from fastjob import FastJob
        
        # Create instance and context
        instance = FastJob(database_url="postgresql://postgres@localhost/fastjob_db_url_test_1")
        ...
        assert current_context.database_url == "postgresql://postgres@localhost/fastjob_db_url_test_1"
...
class TestBackwardsCompatibility:
    ...
    def test_global_api_cli_commands_unchanged(self):
        ...
        try:
            ...
            os.environ["FASTJOB_DATABASE_URL"] = "postgresql://postgres@localhost/fastjob_db_url_test_1"
