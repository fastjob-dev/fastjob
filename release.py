...
class ReleaseManager:
    ...
    def lint_code(self) -> bool:
        ...
        if "flake8" in available_linters:
            if not self.run_command(
                ["flake8", "fastjob/", "--max-line-length", "88", "--ignore", "E203,W503"],
    ...
    def build_package(self) -> bool:
        ...
        if not self.run_command(["python3", "-c", "import build"], "Checking build module"):
    ...
    def run_release(self, skip_tests: bool = False, skip_format: bool = False, 
                   skip_build: bool = False, skip_publish: bool = False) -> bool:
...
def main():
    ...
    parser.add_argument(
        "--skip-format", 
        action="store_true", 
        help="Skip code formatting and linting"
    )
    parser.add_argument(
        "--skip-build", 
        action="store_true", 
